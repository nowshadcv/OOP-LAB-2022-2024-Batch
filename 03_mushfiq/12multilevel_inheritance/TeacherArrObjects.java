...
import multilevel_inheritance.Teacher;
...
public class TeacherArrObjects {
	 public static void main(String[] args) {
	     ...
	     for(int i=0;i<n;i++)
	     {
	         ...
	         Teacher t = new Teacher(name,gender ,address ,age,empid,company_name,qualification,salary,department,subject,teacherid);
	         teacher[i]=t;
	     }
