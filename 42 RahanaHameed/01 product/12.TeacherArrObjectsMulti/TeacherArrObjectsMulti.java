...
class Employeee1 extends Person{
	int empid,salary;
	String companyname,qualification;
	Employeee1(){}
	Employeee1(String name,String gender,String address,int age,int empid,int salary,String companyname,String qualification){
...
class TeacherT extends Employeee1{
	int teacherid;
...
public class TeacherArrObjectsMulti {
